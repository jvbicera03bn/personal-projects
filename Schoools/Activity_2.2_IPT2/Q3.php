...
if (isset($_POST['submit'])){
    ...
    if (is_numeric($txtValue1) && is_numeric($txtValue2) && is_numeric($txtValue3) && is_numeric($txtValue4) && is_numeric($txtValue5) && is_numeric($txtValue6) && is_numeric($txtValue7) && is_numeric($txtValue8)){
        ...
        echo "<script>alert('Average Grade".$average."')</script>";
        $display = "(".$txtValue1."+".$txtValue2."+".$txtValue3."+".$txtValue4."+".$txtValue5."+".$txtValue6."+".$txtValue7."+".$txtValue8.") / 8 = ".$average;
        /* Record at DB */
        $query = "INSERT INTO `tbl_grades` (grade1,grade2,grade3,grade4,grade5,grade6,grade7,grade8,average,ramarks)";
